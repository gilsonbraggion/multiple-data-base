...
@Configuration
@EnableJpaRepositories(basePackages = "com.gabriel.multipledatabaseconnection.repository.inmemory", entityManagerFactoryRef = "inmemoryDatabaseEntityManager", transactionManagerRef = "inmemoryDatabaseTransactionManager")
