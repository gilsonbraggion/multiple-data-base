...
@Configuration
@EnableJpaRepositories(basePackages = "com.gabriel.multipledatabaseconnection.repository.persistent", entityManagerFactoryRef = "persistentDatabaseEntityManager", transactionManagerRef = "persistentDatabaseTransactionManager")
